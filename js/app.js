(function() {
  var app, bcrypt, connect, connection, crypto, fs, gameLibraryMananger, giantBombMananger, handler, imageUploader, io, mysql, request, resourceMananger, server, ss, userRegister, validator, __dirname, __userImagedir;
