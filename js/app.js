...
(function() {
  var addImageToFolder, app, bcrypt, connect, connection, crypto, fs, gameLibraryMananger, giantBombMananger, handler, io, mysql, request, resourceMananger, server, userRegister, validator, __dirname, __userImagedir;
  ...
  io.on('connection', function(client) {
    ...
    return resourceMananger(client, connection);
  });
