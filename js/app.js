...
(function() {
  var addPlatformTogame, app, bcrypt, calculateAllReviewForGame, calculateNewPeers, calculateNewPros, calculateProReviewForGame, caluclatePeerReviewsForGame, connect, connection, crypto, fs, getGamesForUser, getGamesForUserOnPlatform, getGurusGameForUser, getOrCreateGame, getOrCreatePlatform, getOrCreateProReviewer, getPeersGameForUser, getRecentReleases, getReviewLinksForProReviewers, handler, io, mysql, salt, server, updateGameList, validateEmail, validator, __dirname;
  ...
  getGamesForUser = function(username, localuserid, client) {
    ...
    return addGameScore = function(userid, gameid, bombid, callback) {
      sql = 'Select * from ';
