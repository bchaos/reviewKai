...
(function() {
  var addImageToFolder, app, bcrypt, connect, connection, crypto, fs, gameLibraryMananger, handler, io, mysql, server, userRegister, validator, __dirname, __userImagedir;
  ...
  io.on('connection', function(client) {
    ...
    return gameLibraryMananger(client, connection);
  });
