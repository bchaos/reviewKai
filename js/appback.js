...
(function() {
  var addGameScore, app, bcrypt, calculateAllReviewForGame, calculateNewPeers, calculateNewPros, calculateProReviewForGame, caluclatePeerReviewsForGame, connect, connection, crypto, fs, getGamesForUser, getGurusGameForUser, getOrCreateGame, getPeersGameForUser, getRecentReleases, getReviewLinksForProReviewers, handler, io, mysql, salt, server, updateGameList, validateEmail, validator, __dirname;
  ...
  io.on('connection', function(client) {
    ...
    return client.on('AddNewProGameToLibrary', function(data) {
      return getOrCreateGame(data.giantBombinfo, function(gameid) {
        var sql;
        data.userInfo.game_id = gameid;
