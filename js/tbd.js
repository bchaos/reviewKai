...
(function() {
  var DialogController, app, confidantController, createGameDetailViewer, dashboardController, genericController, guruController, homeController, isloggedin, libraryController, peerController, recommendationController, reviewController, searchController, signInSetup;
  ...
  app.controller('reviewController', reviewController = (function() {
    reviewController.$inject = ['$scope', '$location', 'socket', '$ionicModal', '$mdDialog'];

    function reviewController($scope, $location, socket, $ionicModal, $mdDialog) {
      this.$scope = $scope;
  ...
  app.controller('libraryController', libraryController = (function() {
    libraryController.$inject = ['$scope', '$ionicModal', 'socket', '$location', '$ionicPopover', '$mdDialog'];

    function libraryController($scope, $ionicModal, socket, $location, $ionicPopover, $mdDialog) {
      var myDropzone, path;
      this.$scope = $scope;
      this.socket = socket;
      this.$location = $location;
