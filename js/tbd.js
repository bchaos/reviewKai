...
(function() {
  ...
  createGameDetailViewer = function($ionicModal, $scope, socket, $location) {
  ...
  app.controller('dashboardController', dashboardController = (function() {
    dashboardController.$inject = ['$scope', '$ionicModal', 'socket', '$location'];

    function dashboardController($scope, $ionicModal, socket, $location) {
      this.$scope = $scope;
      this.socket = socket;
      $scope.isLoading = true;
