...
(function() {
  ...
  createGameDetailViewer = function($ionicModal, $scope, socket, InfoRequestService) {
    ...
    createNumberList = function() {
      var firstPage, hasElispes, i, j, lastPage, length, ref, ref1;
      ...
      for (i = j = ref = firstPage, ref1 = lastPage; ref <= ref1 ? j < ref1 : j > ref1; i = ref <= ref1 ? ++j : --j) {
        $scope.pages.push({
          number: i,
  ...
  app.controller('reviewController', reviewController = (function() {
    ...
    function reviewController($scope1, InfoRequestService1, $location1, socket1, $ionicModal) {
      this.$scope = $scope1;
      this.InfoRequestService = InfoRequestService1;
  ...
  app.controller('homeController', homeController = (function() {
    ...
    function homeController($scope1, $ionicModal, socket1) {
      this.$scope = $scope1;
      this.socket = socket1;
  ...
  app.controller('searchController', searchController = (function() {
    ...
    function searchController($scope1, InfoRequestService1, $ionicModal, socket1, $location1) {
      var searchObject;
      this.$scope = $scope1;
      this.InfoRequestService = InfoRequestService1;
      this.socket = socket1;
  ...
  app.controller('dashboardController', dashboardController = (function() {
    ...
    function dashboardController($scope1, InfoRequestService1, $ionicModal, socket1) {
      this.$scope = $scope1;
      this.InfoRequestService = InfoRequestService1;
      this.socket = socket1;
      $scope.scoreName = 'peerscore';
  ...
  app.controller('peerController', peerController = (function() {
    ...
    function peerController($scope1, InfoRequestService1, $ionicModal, socket1) {
      this.$scope = $scope1;
      this.InfoRequestService = InfoRequestService1;
      this.socket = socket1;
      $scope.myLibrary = false;
  ...
  app.controller('guruController', guruController = (function() {
    ...
    function guruController($scope1, InfoRequestService1, $ionicModal, socket1) {
      this.$scope = $scope1;
      this.InfoRequestService = InfoRequestService1;
      this.socket = socket1;
      $scope.myLibrary = false;
  ...
  app.controller('libraryController', libraryController = (function() {
    ...
    function libraryController($scope1, InfoRequestService1, $ionicModal, socket1) {
      this.$scope = $scope1;
      this.InfoRequestService = InfoRequestService1;
      this.socket = socket1;
      $scope.loggedin = true;
  ...
  app.controller('proController', proController = (function() {
    ...
    function proController($scope1, InfoRequestService1, $ionicModal, socket1) {
      this.$scope = $scope1;
      this.InfoRequestService = InfoRequestService1;
      this.socket = socket1;
      $scope.myLibrary = true;
  ...
  app.controller('proLibraryController', proLibraryController = (function() {
    ...
    function proLibraryController($scope1, InfoRequestService1, $ionicModal, socket1, $location1) {
      var searchObject;
      this.$scope = $scope1;
      this.InfoRequestService = InfoRequestService1;
      this.socket = socket1;
  ...
  app.controller('dataparserController', dataparserController = (function() {
    ...
    function dataparserController($scope1, InfoRequestService1, socket1) {
      ...
      $scope.uploadImage = function(files) {
        ...
        reader.readAsText(file);
        return reader.onload = function(event) {
          var OrganizedData, csv, data, gamedata, j, len, length, organized;
          csv = event.target.result;
